...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "chardet.compat");
...
void checkModuleConstants_chardet$compat(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "chardet.compat");
}
#endif
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "chardet.compat";

// Internal entry point for module code.
PyObject *modulecode_chardet$compat(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("chardet.compat: Skipping module init, already done.\n");
#endif
