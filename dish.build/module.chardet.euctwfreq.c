...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "chardet.euctwfreq");
...
void checkModuleConstants_chardet$euctwfreq(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "chardet.euctwfreq");
}
#endif
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "chardet.euctwfreq";

// Internal entry point for module code.
PyObject *modulecode_chardet$euctwfreq(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("chardet.euctwfreq: Skipping module init, already done.\n");
#endif
