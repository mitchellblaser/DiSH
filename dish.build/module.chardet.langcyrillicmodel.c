...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "chardet.langcyrillicmodel");
...
void checkModuleConstants_chardet$langcyrillicmodel(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "chardet.langcyrillicmodel");
}
#endif
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "chardet.langcyrillicmodel";

// Internal entry point for module code.
PyObject *modulecode_chardet$langcyrillicmodel(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("chardet.langcyrillicmodel: Skipping module init, already done.\n");
#endif
