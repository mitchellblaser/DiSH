...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "chardet.langgreekmodel");
...
void checkModuleConstants_chardet$langgreekmodel(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "chardet.langgreekmodel");
}
#endif
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "chardet.langgreekmodel";

// Internal entry point for module code.
PyObject *modulecode_chardet$langgreekmodel(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("chardet.langgreekmodel: Skipping module init, already done.\n");
#endif
